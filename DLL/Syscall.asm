RegisterSyscallGroup proto stdcall info:UHCInfoPtr, groupName:DWORD, :DWORD
...
code_cave_begin 07294F4h
	invoke RegisterSyscallGroup, _UHCInfoPtr, GroupAI, esi
code_cave_end 07294F4h

; HC
code_cave_begin 05B5E08h
	invoke RegisterSyscallGroup, _UHCInfoPtr, GroupHC, esi
code_cave_end 05B5E08h

; KB
code_cave_begin 0885D14h
	invoke RegisterSyscallGroup, _UHCInfoPtr, GroupKB, esi
code_cave_end 0885D14h

; RM
code_cave_begin 060B8BFh
	invoke RegisterSyscallGroup, _UHCInfoPtr, GroupRM, esi
code_cave_end 060B8BFh

; TR
code_cave_begin 0988E03h
	invoke RegisterSyscallGroup, _UHCInfoPtr, GroupTR, esi
code_cave_end 0988E03h

; UI
code_cave_begin 0539542h
	invoke RegisterSyscallGroup, _UHCInfoPtr, GroupUI, esi
code_cave_end 0539542h

; UI2
code_cave_begin 053575Eh
	invoke RegisterSyscallGroup, _UHCInfoPtr, GroupUI2, esi
code_cave_end 053575Eh

; XS
code_cave_begin 06257D9h
	invoke RegisterSyscallGroup, _UHCInfoPtr, GroupXS, esi
